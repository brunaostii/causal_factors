...
if __name__ == "__main__":
    ...
    parser.add_argument("--splits_folder", type=str, default='../../data/isic/splits/', help="Base folder storing train, val, and test splits in csv files")
    ...
    parser.add_argument('--ds_path', default='../../data/isic/isic2019/ISIC_2019_Training_Input')
